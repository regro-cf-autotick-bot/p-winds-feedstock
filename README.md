...
Once the `conda-forge` channel has been enabled, `p-winds` can be installed with:

```
conda install p-winds
```

It is possible to list all of the versions of `p-winds` available on your platform with:
